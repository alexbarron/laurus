class ApplicationController < ActionController::Base
  ...
  def find_current_user_membership(developer_app)
  ...
  def authorized_to_view_app?(_developer_app)
    return if current_user.platform_admin? || @current_user_membership&.kept?
  ...
  def authorized_to_edit_app?(developer_app)
    return if current_user.platform_admin? || @current_user_membership&.active_admin?
